...
<mapper namespace="org.kms-dao.dao.${pojoName}Dao">
	<insert id="add" parameterType="org.kms-dao.pojo.${pojoName}"
	...
	<update id="update" parameterType="org.kms-dao.pojo.${pojoName}">
	...
	<select id="getAll" resultType="org.kms-dao.pojo.${pojoName}">
	...
	<select id="getById" parameterType="int" resultType="org.kms-dao.pojo.${pojoName}">
		select * from ${t}${table_name} where id = ${jing}{id}
	</select>
	
	
	<select id="getListByCondition" resultType="org.kms-dao.pojo.${pojoName}">
		select * from ${t}${table_name}
